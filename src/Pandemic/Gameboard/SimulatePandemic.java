...
public class SimulatePandemic
{
    public static void main(String[] args) throws CloneNotSupportedException 
	{
	  ...
	  unabomber = new Player("Unabomber","QUARANTINE_SPECIALIST",0);
	  jack = new Player("Jesus","OPERATIONS_EXPERT",0);
	  jesus = new Player("Jack the Ripper","SCIENTIST",0);
	  deadpool = new Player ("Zodiac Killer","MEDIC",0);
